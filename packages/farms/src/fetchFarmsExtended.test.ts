...
import { getFarmsPrices } from './fetchFarmsExtended'
import { FarmExtendedData } from './types'

describe('fetchGlobalFarms', () => {
  it('getFarmsPrices', async () => {
    const farmsData: FarmExtendedData[] = [
      // WAYA Pair
      // @ts-ignore
      {
        pid: 1,
        lpSymbol: 'WBNB-WAYA LP',
        lpAddress: Pool.getAddress(bscTokens.wbnb, bscTokens.waya, FeeAmount.MEDIUM),
        token: bscTokens.wbnb,
        quoteToken: bscTokens.waya,
    ...
    expect(getFarmsPrices(farmsData, wayaPrice, commonPrice)).toMatchInlineSnapshot(`
      [
        {
          "feeAmount": 2500,
          "lmPool": "",
          ...
          "quoteToken": ERC20Token {
            ...
            "isToken": true,
            "name": "Plexswap Token",
            "projectLink": "https://plexswap.finance/",
            "symbol": "WAYA",
          },
