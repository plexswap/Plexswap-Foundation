...
```bash
$ pnpm add @plexswap/multicall @plexswap/sdk viem
```
...
For supported chains and contract addresses, please refer to [multicall contracts](https://github.com/plexswap/plexswap-frontend/blob/develop/packages/multicall/src/constants/contracts.ts).
