import { Currency, CurrencyAmount, ERC20Token, Pair, Percent, Price, Trade, TradeType } from '@plexswap/sdk-core'
...
export function createStableSwapPair(
  ...
  return {
    ...
    liquidityToken: new ERC20Token(pair.token0.chainId, lpAddress, 18, 'Stable-LP', 'Plex StableSwap LPs'),
...
export function createTradeWithStableSwapFromCoreTrade<TIn extends Currency, TOut extends Currency>({
  tradeType,
  inputAmount,
  outputAmount,
  route: { pairs },
