...
export enum CommandType {
  ...
  EXTENDED_SWAP_EXACT_IN = 0x00,
  EXTENDED_SWAP_EXACT_OUT = 0x01,
  ...
  CORE_SWAP_EXACT_IN = 0x08,
  CORE_SWAP_EXACT_OUT = 0x09,
  PERMIT2_PERMIT = 0x0a,
  WRAP_ETH = 0x0b,
  UNWRAP_WETH = 0x0c,
  ...
  // PLEXSWAP_NFT_BNB = 0x24,
  // PLEXSWAP_NFT_WBNB = 0x25,
}
...
export const ABI_PARAMETER = {
  ...
  // swap actions
  [CommandType.EXTENDED_SWAP_EXACT_IN]: parseAbiParameters(
    'address recipient, uint256 amountIn, uint256 amountOutMin, bytes path, bool payerIsUser',
  ),
  [CommandType.EXTENDED_SWAP_EXACT_OUT]: parseAbiParameters(
    'address recipient, uint256 amountOut, uint256 amountInMax, bytes path, bool payerIsUser',
  ),
  [CommandType.CORE_SWAP_EXACT_IN]: parseAbiParameters(
    'address recipient, uint256 amountIn, uint256 amountOutMin, address[] path, bool payerIsUser',
  ),
  [CommandType.CORE_SWAP_EXACT_OUT]: parseAbiParameters(
  ...
  // ),
  // [CommandType.PLEXSWAP_NFT_WBNB]: parseAbiParameters('address collection, uint256 tokenId, uint256 price'),
  // [CommandType.PLEXSWAP_NFT_BNB]: parseAbiParameters('address collection, uint256 tokenId, uint256 price'),
