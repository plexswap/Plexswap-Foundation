export const plexRouterABI = [
    {
      inputs: [
        { internalType: 'address', name: '_factoryCore', type: 'address' },
      ...
      inputs: [
        {
          ...
          internalType: 'struct IExtendedRouter.ExactInputParams',
          name: 'params',
          type: 'tuple',
        },
      ],
      ...
      inputs: [
        {
          ...
          internalType: 'struct IExtendedRouter.ExactInputSingleParams',
          name: 'params',
          type: 'tuple',
        },
      ],
      ...
      inputs: [
        {
          ...
          internalType: 'struct IExtendedRouter.ExactOutputParams',
          name: 'params',
          type: 'tuple',
        },
      ],
      ...
      inputs: [
        {
          ...
          internalType: 'struct IExtendedRouter.ExactOutputSingleParams',
          name: 'params',
          type: 'tuple',
        },
      ],
