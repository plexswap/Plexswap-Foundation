export const mixedRouteQuoterABI = [
  {
    inputs: [
      {
  ...
  },
  {
    ...
    outputs: [
      ...
      },
      {
        ...
        name: 'extendedSqrtPriceX96AfterList',
        type: 'uint160[]',
      },
      {
        internalType: 'uint32[]',
        name: 'extendedInitializedTicksCrossedList',
        type: 'uint32[]',
      },
      {
        internalType: 'uint256',
        name: 'extendedSwapGasEstimate',
        type: 'uint256',
      },
    ],
    stateMutability: 'nonpayable',
