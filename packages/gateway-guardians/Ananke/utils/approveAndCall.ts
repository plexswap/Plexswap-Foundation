import { Currency, Percent, Token } from '@plexswap/sdk-core'
import { IncreaseSpecificOptions, MintSpecificOptions, NonfungiblePositionManager, Position } from '@plexswap/sdk-extended'
import invariant from 'tiny-invariant'
import { Address, Hex, encodeFunctionData } from 'viem'

import { approveAndCallAbi } from '../../config/abis/IApproveAndCall'

// condensed version of @plexswap/pool AddLiquidityOptions containing only necessary swap + add attributes
