...
import { Currency, Token, WNATIVE } from '@plexswap/sdk-core'
import { Address } from 'viem'

import { BASES_TO_CHECK_TRADES_AGAINST } from './../../../config/constants'
import { ExtendedPoolWithTvl, CorePoolWithTvl, PoolSelectorConfig, WithTvl } from '../../types'
import { getPoolAddress as getPoolAddressUtil } from '../../utils'
import { getExtendedPoolSelectorConfig, getCorePoolSelectorConfig } from '../../utils/getPoolSelectorConfig'
...
export const extendedPoolTvlSelector = poolSelectorFactory<ExtendedPoolWithTvl>({
  getPoolSelectorConfig: getExtendedPoolSelectorConfig,
  getToken0: (p) => p.token0,
  getToken1: (p) => p.token1,
  getPoolAddress: (p) => p.address,
})

export const corePoolTvlSelector = poolSelectorFactory<CorePoolWithTvl>({
  getPoolSelectorConfig: getCorePoolSelectorConfig,
