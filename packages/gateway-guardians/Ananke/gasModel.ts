...
import { BigintIsh, Currency, CurrencyAmount, Price } from '@plexswap/sdk-core'
...
import { getNativeWrappedToken, getTokenPrice, getUsdGasToken, isExtendedPool, isStablePool, isCorePool } from './utils'
...
export async function createGasModel({
  ...
  const estimateGasCost = (
    ...
    /**
     * Since we must make a separate call to multicall for each extended and v2 section, we will have to
