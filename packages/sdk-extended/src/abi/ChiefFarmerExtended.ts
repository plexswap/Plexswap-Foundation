export const chiefFarmerExtendedABI = [
  {
    inputs: [
      { internalType: 'contract IERC20', name: '_WAYA', type: 'address' },
      {
  ...
  { inputs: [], name: 'NotPlexswapNFT', type: 'error' },
  ...
  { inputs: [], name: 'ZeroAddress', type: 'error' },
  {
    ...
    inputs: [
      ...
      { indexed: true, internalType: 'contract IPlexswapExtendedPool', name: 'extendedPool', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'wayaPerSecond', type: 'uint256' },
      { indexed: false, internalType: 'uint256', name: 'wayaAmount', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'remainingWaya', type: 'uint256' },
    ],
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'contract IPlexswapExtendedPool', name: '_extendedPool', type: 'address' },
  ...
  {
    inputs: [{ internalType: 'address', name: '_extendedPool', type: 'address' }],
    name: 'getLatestPeriodInfo',
    outputs: [
      { internalType: 'uint256', name: 'wayaPerSecond', type: 'uint256' },
