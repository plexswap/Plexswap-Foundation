export const extendedStakerABI = [
  {
    inputs: [
      {
        internalType: 'contract IUniswapExtendedFactory',
        name: '_factory',
        type: 'address',
      },
      {
  ...
  },
  {
    ...
    inputs: [
      ...
      {
        indexed: true,
        internalType: 'contract IUniswapExtendedPool',
        name: 'pool',
        type: 'address',
      },
      {
    ...
    inputs: [
      {
        ...
        internalType: 'struct IUniswapExtendedStaker.IncentiveKey',
        name: 'key',
        type: 'tuple',
      },
      {
