...
import { BigintIsh, CurrencyAmount, Price, Token } from '@plexswap/sdk-core'
import invariant from 'tiny-invariant'
import { Address, Hash } from 'viem'
import { POOL_DEPLOYER_ADDRESSES, FeeAmount, TICK_SPACINGS } from '../constants'
...
export class Pool {
  ...
  public static getAddress(
    ...
    return computePoolAddress({
      deployerAddress: deployerAddressOverride ?? POOL_DEPLOYER_ADDRESSES[tokenA.chainId as ChainId],
      fee,
      tokenA,
      tokenB,
