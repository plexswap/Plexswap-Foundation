...
import { quoterCoreABI } from './abi/QuoterCore'
...
/**
 * Represents the Plexswap Extended QuoterV1 contract with a method for returning the formatted
 * calldata needed to call the quoter contract.
 */
export abstract class SwapQuoter {
  public static V1ABI = quoterABI

  public static V2ABI = quoterCoreABI

  /**
   * Produces the on-chain method name of the appropriate function within QuoterCore,
  ...
  public static quoteCallParameters<TInput extends Currency, TOutput extends Currency>(
    ...
    let calldata: Hex
    const swapAbi = options.useQuoterCore ? this.V2ABI : this.V1ABI
