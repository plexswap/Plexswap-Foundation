import { BigintIsh, Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress } from '@plexswap/sdk-core'
...
/**
 * Represents the Plexswap Extended SwapRouter, and has static methods for helping execute trades.
 */
