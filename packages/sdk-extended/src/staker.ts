import { BigintIsh, Token, validateAndParseAddress } from '@plexswap/sdk-core'
import { Address, Hex, encodeAbiParameters, encodeFunctionData, parseAbiParameters } from 'viem'
import { extendedStakerABI } from './abi/ExtendedStaker'
...
export abstract class Staker {
  public static ABI = extendedStakerABI
