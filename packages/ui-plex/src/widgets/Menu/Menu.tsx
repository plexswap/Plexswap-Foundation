import { useIsMounted } from "@plexswap/hooks";
  ...
  return (
    <MenuContext.Provider value={providerValue}>
            ...
            <StyledNav>
              ...
              <Flex alignItems="center" height="100%">
                <AtomBox mr="12px" display={{ xs: "none", lg: "block" }}>
                  <WayaPrice chainId={chainId} showSkeleton={false} wayaPriceUsd={wayaPriceUsd} />
                </AtomBox>
                <Box mt="4px">
                  <LangSelector
      ...
      <Footer
        ...
        buyWayaLabel={buyWayaLabel}
        buyWayaLink={buyWayaLink}
