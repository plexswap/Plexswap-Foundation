...
import { animation as ANIMATION, SkeletonCoreProps, SkeletonProps, variant as VARIANT } from "./types";
...
export const SkeletonCore: React.FC<React.PropsWithChildren<SkeletonCoreProps>> = ({
  variant = VARIANT.RECT,
  animation = ANIMATION.PULSE,
  isDataReady = false,
  children,
