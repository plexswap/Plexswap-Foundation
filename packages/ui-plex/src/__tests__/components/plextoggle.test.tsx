...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c0 .plexswap:nth-child(3) {
      top: -6px;
      transform: scale(0);
      transition: 0.2s ease 0.2s;
    }

    .c0 .plexswap:nth-child(3):before,
    .c0 .plexswap:nth-child(3):after {
      content: "";
      position: absolute;
      background: #ef8927;
      border-radius: 20px;
    ...
    .c1:checked+label .plexswaps {
      transform: translateX(24px);
    }

    .c1:checked+label .plexswap:nth-child(1) {
      background: #e27c31;
      box-shadow: 0 1.5px 0 1.5px #fbbe7c;
      transition-delay: 0.2s;
    }

    .c1:checked+label .plexswap:nth-child(2) {
      transform: scale(1);
      transition-delay: 0.2s;
    }

    .c1:checked+label .plexswap:nth-child(3) {
      transform: scale(1);
