...
it("renders link correctly", () => {
  const { asFragment } = renderWithProvider(<Link href="https://plexswap.finance">Link</Link>);
...
it("renders link external link correctly", () => {
  const { asFragment } = renderWithProvider(<LinkExternal href="https://plexswap.finance">Link</LinkExternal>);
  expect(asFragment()).toMatchInlineSnapshot(`
    <DocumentFragment>
      .c0 {
      color: var(--colors-primary);
