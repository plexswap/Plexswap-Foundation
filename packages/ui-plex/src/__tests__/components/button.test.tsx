...
it("renders correctly", () => {
  ...
  expect(asFragment()).toMatchInlineSnapshot(`
    ...
    .c0:active:not(:disabled):not(.plexswap-button--disabled):not(.plexswap-button--disabled) {
      opacity: 0.85;
    ...
    @media (hover: hover) {
      .c0:hover:not(:disabled):not(.plexswap-button--disabled):not(.plexswap-button--disabled):not(:active) {
        opacity: 0.65;
      }
    }
