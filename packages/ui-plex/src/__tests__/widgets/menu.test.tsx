import type { Language } from "@plexswap/localization";
  ...
  const { asFragment } = renderWithProvider(
    <BrowserRouter>
      <Menu
        ...
        setLang={noop}
        currentLang="en-US"
        wayaPriceUsd={0.23158668932877668}
        links={menuConfig}
        subLinks={menuConfig[0].items as SubMenuItemsType[]}
        footerLinks={footerLinks}
        activeItem="Trade"
        activeSubItem="Exchange"
        buyWayaLabel="Buy WAYA"
        buyWayaLink="https://plexswap.finance/swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82&chainId=56"
      >
        body
      </Menu>
    </BrowserRouter>
