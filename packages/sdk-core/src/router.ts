...
/**
 * The parameters to use in the call to the Plexswap Router to execute a trade.
 */
export interface SwapParameters {
  /**
   * The method to call on the Plexswap Router.
   */
  methodName: string
  /**
...
/**
 * Represents the PlexswapRouter, and has static methods for helping execute trades.
 */
