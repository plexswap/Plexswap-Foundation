...
import { Box, Spinner as SpinnerAlias, SpinnerProps, Svg } from '@plexswap/ui-plex';
...
const LoadingIndicator = styled(LoaderExtended)`
  stroke: grey;
  fill: grey;
...
export function LoaderExtended({ size = "4px", ...rest }: { size?: string; [k: string]: any }) {
