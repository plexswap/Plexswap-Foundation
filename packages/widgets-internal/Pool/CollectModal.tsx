...
import  { AutoRenewIcon, Button, Flex, Heading, Modal, Text } from '@plexswap/ui-plex';
...
export interface CollectModalWithHandlerProps extends Omit<CollectModalProps, "isBnbPool" | "poolId"> {
