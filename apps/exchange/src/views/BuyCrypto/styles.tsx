import { Box, Button, Flex, InputProps } from '@plexswap/ui-plex'
import { scales } from '@plexswap/ui-plex/components/Toggle/types'
...
export const DropDownContainer = styled.div<{ error: boolean }>`
  ...
  justify-content: space-between;
  padding: 12px 16px;
  box-shadow: ${({ theme, error }) => (error ? theme.shadows.warning : theme.shadows.inset)};
