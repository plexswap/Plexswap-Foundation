...
import { Route, SmartRouterTrade } from '@plexswap/gateway-guardians/Ananke'
import { Currency, CurrencyAmount, Percent, Price, TradeType, ZERO_PERCENT } from '@plexswap/sdk-core'
import { useMemo } from 'react'
import { Field } from 'state/swap/actions'

import { SlippageAdjustedAmounts } from 'views/Swap/ExtendedSwap/utils/exchange'
