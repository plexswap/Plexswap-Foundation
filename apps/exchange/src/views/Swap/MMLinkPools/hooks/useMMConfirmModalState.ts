...
import { ConfirmModalState } from '@plexswap/widgets-internal'
...
import { ConfirmAction } from 'views/Swap/ExtendedSwap/hooks/useConfirmModalState'
import { userRejectedError } from 'views/Swap/ExtendedSwap/hooks/useSendSwapTransaction'
...
const useConfirmActions = (
  trade: SmartRouterTrade<TradeType> | AetherRouter.AetherTradeWithoutGraph<TradeType> | undefined,
