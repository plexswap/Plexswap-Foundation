...
import { Currency, Trade, TradeType } from '@plexswap/sdk-core'
import { useExpertMode, useUserSlippage } from '@plexswap/utils/user'
...
export function useDerivedSwapInfoWithMM<T extends TradeEssentials>(
  ...
  coreTrade?: Trade<Currency, Currency, TradeType>,
