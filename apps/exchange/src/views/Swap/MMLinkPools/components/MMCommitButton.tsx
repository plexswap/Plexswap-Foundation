...
import { ConfirmSwapModal } from 'views/Swap/ExtendedSwap/containers/ConfirmSwapModal'
import { CommitButtonProps } from 'views/Swap/ExtendedSwap/types'
...
type Trade = SmartRouterTrade<TradeType> | AetherRouter.AetherTrade<TradeType>
