...
import { AutoColumn, Box, Button, Dots, Message, MessageText, Text, useModal } from '@plexswap/ui-plex'
import React, { memo, useCallback, useEffect, useMemo, useState } from 'react'

import { useTranslation } from '@plexswap/localization'
import { getEvolusRouterAddress } from "@plexswap/gateway-guardians/Evolus"
...
const SwapCommitButtonInner = memo(function SwapCommitButtonInner({
  ...
  const { callToAction, confirmState, txHash, confirmActions, errorMessage, resetState } = useConfirmModalState(
    ...
    getEvolusRouterAddress(chainId),
  )
