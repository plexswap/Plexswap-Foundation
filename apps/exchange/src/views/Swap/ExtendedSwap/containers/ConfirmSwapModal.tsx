...
import { Currency, CurrencyAmount, Token, TradeType } from '@plexswap/sdk-core'
import { Box, BscScanIcon, Column, Flex, InjectedModalProps, Link, Text } from '@plexswap/ui-plex'
...
type ConfirmSwapModalProps = InjectedModalProps & {
  ...
  isMM?: boolean
  trade?: SmartRouterTrade<TradeType> | AetherRouter.AetherTrade<TradeType>
  originalTrade?: SmartRouterTrade<TradeType> | AetherRouter.AetherTrade<TradeType>
