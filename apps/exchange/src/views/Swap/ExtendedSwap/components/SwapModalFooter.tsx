...
import { SmartRouter, SmartRouterTrade } from '@plexswap/gateway-guardians/Ananke'
import { Currency, CurrencyAmount, Percent, TradeType } from '@plexswap/sdk-core'
import { AutoColumn, BackForwardIcon, Button, Flex, Link, QuestionHelper, Text } from '@plexswap/ui-plex'
import { formatAmount } from '@plexswap/utils/formatFractions'
              ...
              text={
                isMM ? (
                  <>
                    ...
                    <Text>- {t('%amount% towards WAYA buyback and burn', { amount: buyBackFeePercent })}</Text>
                    <Text mt="12px">
                      ...
                      <Link
                        ...
                        ml="4px"
                        external
                        href="https://docs.plexswap.finance/products/stableswap#stableswap-fees"
                      >
                        {t('here.')}
                      </Link>
                    </Text>
                  ...
                  <>
                    ...
                    <Text mt="12px">
                      <Link
                        ...
                        ml="4px"
                        external
                        href="https://docs.plexswap.finance/products/plexswap-exchange/faq#what-will-be-the-trading-fee-breakdown-for-extended-exchange"
                      >
