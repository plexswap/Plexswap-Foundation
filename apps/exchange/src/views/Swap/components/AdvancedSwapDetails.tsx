...
import { CorePair as Pair } from '@plexswap/gateway-guardians/Khaos'
import { Currency, CurrencyAmount, Percent, TradeType } from '@plexswap/sdk-core'
import { AutoColumn, Flex, Link, Modal, ModalCore, QuestionHelper, SearchIcon, Text } from '@plexswap/ui-plex'
import { formatAmount, formatFraction } from '@plexswap/utils/formatFractions'
import { memo, useState } from 'react'
import { NumberDisplay } from '@plexswap/widgets-internal'
import { RowBetween, RowFixed } from 'components/Layout/Row'
import { RoutingSettingsButton } from 'components/Menu/GlobalSettings/SettingsModal'
import { Field } from 'state/swap/actions'
import { SlippageAdjustedAmounts } from '../ExtendedSwap/utils/exchange'
        ...
        <RowBetween align="flex-start">
          <RowFixed>
            ...
            <QuestionHelper
              text={
                <>
                  <Text>{t('Fees saved on Plexswap compared to major DEXs charging interface fees')}</Text>
                </>
              }
              ml="4px"
              placement="top"
                ...
                <>
                  ...
                  <Text mt="12px">
                    <Link
                      ...
                      href={
                        isMM
                          ? 'https://docs.plexfinance.us/products/plexswap-exchange/market-maker-integration#fees'
                          : 'https://docs.plexfinance.us/products/plexswap-exchange/faq#what-will-be-the-trading-fee-breakdown-for-extended-exchange'
                      }
                    >
                  ...
                  <Text mt="10px">
                    ...
                    :{' '}
                    {t(
                      'Plexswap does not charge any fees for trades. However, the market makers charge an implied fee of 0.05% - 0.25% (non-stablecoin) / 0.01% (stablecoin) factored into the quotes provided by them.',
                    )}
                  </Text>
                </>
              }
          ...
          {showRoute && (
            <>
              <RowBetween style={{ padding: '0 24px' }}>
                ...
                <ModalCore closeOnOverlayClick isOpen={isModalOpen} onDismiss={() => setIsModalOpen(false)}>
                  <Modal
                    title={
