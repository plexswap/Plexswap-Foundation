import { CoreStableSwapPair } from '@plexswap/gateway-guardians/Khaos'
...
import { stableSwapABI } from 'config/abi/stableSwap'
import { useContract } from 'hooks/useContract'
import { useStableSwapPairs } from 'state/swap/useStableSwapPairs'
import { useTokenBalancesWithLoadingIndicator } from 'state/wallet/hooks'
import { Address } from 'viem'

interface StableSwapConfigType extends CoreStableSwapPair {
