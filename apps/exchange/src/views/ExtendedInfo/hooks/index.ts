...
import { extendedClients, extendedInfoClients } from 'utils/graphql'
...
export const useProtocolChartData = (): ChartDayData[] | undefined => {
  ...
  const { data: chartData } = useQuery({
    queryKey: [`extended/info/protocol/ProtocolChartData/${chainId}`, chainId],
    queryFn: () => fetchChartData(extendedInfoClients[chainId]),
...
export const useProtocolData = (): ProtocolData | undefined => {
  ...
  const { data } = useQuery({
    queryKey: [`extended/info/protocol/ProtocolData/${chainId}`, chainId],
    queryFn: () => fetchProtocolData(extendedInfoClients[chainId], blocks),
...
export const useProtocolTransactionData = (): Transaction[] | undefined => {
  ...
  const chainId = multiChainId[chainName]
  const { data } = useQuery({
    queryKey: [`extended/info/protocol/ProtocolTransactionData/${chainId}`, chainId],
    queryFn: () => fetchTopTransactions(extendedInfoClients[chainId]),
    enabled: Boolean(chainId),
    ...QUERY_SETTINGS_IMMUTABLE,
  })
...
export const useTokenPriceChartData = (
  ...
  const { data } = useQuery({
    queryKey: [`extended/info/token/priceData/${address}/${duration}`, targetChainId ?? chainId],
    ...
    queryFn: () =>
      fetchTokenPriceData(
        ...
        startTimestamp,
        extendedInfoClients[targetChainId ?? chainId],
...
export const usePairPriceChartTokenData = (
  ...
  const { data } = useQuery({
    queryKey: [`extended/info/token/pairPriceChartToken/${address}/${duration}`, targetChainId ?? chainId],
    ...
    queryFn: async () => {
      ...
      return fetchPairPriceChartTokenData(
        ...
        DURATION_INTERVAL[duration ?? 'day'],
        startTimestamp,
        extendedClients[targetChainId ?? chainId],
        multiChainName[targetChainId ?? chainId],
        SUBGRAPH_START_BLOCK[chainId],
      )
    },
...
export const useTopTokensData = ():
  ...
  const { data } = useQuery({
    queryKey: [`extended/info/token/TopTokensData/${chainId}`, chainId],

    queryFn: () =>
      fetchTopTokens(
        extendedInfoClients[chainId],
...
export const useTokensData = (addresses: string[], targetChainId?: ChainId): TokenData[] | undefined => {
  ...
  const { data } = useQuery({
    queryKey: [`extended/info/token/tokensData/${targetChainId}/${addresses?.join()}`, chainId],

    queryFn: () =>
      tokenDataFetcher(
        extendedInfoClients[chainId], // TODO:  extendedInfoClients[chainId],
        addresses,
        blocks?.filter((d) => d.number >= SUBGRAPH_START_BLOCK[chainId]),
      ),
...
export const useTokenData = (address: string): TokenData | undefined => {
  ...
  const { data } = useQuery({
    queryKey: [`extended/info/token/tokenData/${chainId}/${address}`, chainId],
...
export const usePoolsForToken = (address: string): string[] | undefined => {
  ...
  const chainId = multiChainId[chainName]
  const { data } = useQuery({
    queryKey: [`extended/info/token/poolsForToken/${chainId}/${address}`, chainId],
    queryFn: () => fetchPoolsForToken(address, extendedInfoClients[chainId]),
    enabled: Boolean(chainId && address),
    ...QUERY_SETTINGS_IMMUTABLE,
  })
...
export const useTokenChartData = (address: string): TokenChartEntry[] | undefined => {
  ...
  const { data } = useQuery({
    queryKey: [`extended/info/token/tokenChartData/${chainId}/${address}`, chainId],
    queryFn: () => fetchTokenChartData(address, extendedInfoClients[chainId]),
    enabled: Boolean(chainId && address),
    ...QUERY_SETTINGS_IMMUTABLE,
  })
  return data?.data
...
export const useTokenPriceData = (
  ...
  const { data } = useQuery({
    queryKey: [`extended/info/token/tokenPriceData/${chainId}/${address}/${interval}/${timeWindow}`, chainId],
...
export const useTokenTransactions = (address: string): Transaction[] | undefined => {
  ...
  const chainId = multiChainId[chainName]
  const { data } = useQuery({
    queryKey: [`extended/info/token/tokenTransaction/${chainId}/${address}`, chainId],
    queryFn: () => fetchTokenTransactions(address, extendedInfoClients[chainId]),
    enabled: Boolean(chainId && address),
    ...QUERY_SETTINGS_IMMUTABLE,
  })
...
export const useTopPoolsData = ():
  ...
  const { data } = useQuery({
    queryKey: [`extended/info/pool/TopPoolsData/${chainId}`, chainId],
...
export const usePoolsData = (addresses: string[]): PoolData[] | undefined => {
  ...
  const { data } = useQuery({
    queryKey: [`extended/info/pool/poolsData/${chainId}/${addresses.join()}`, chainId],
...
export const usePoolData = (address: string): PoolData | undefined => {
  ...
  const { data } = useQuery({
    queryKey: [`extended/info/pool/poolData/${chainId}/${address}`, chainId],
...
export const usePoolTransactions = (address: string): Transaction[] | undefined => {
  ...
  const { data } = useQuery({
    queryKey: [`extended/info/pool/poolTransaction/${chainId}/${address}`, chainId],
    queryFn: () => fetchPoolTransactions(address, extendedInfoClients[chainId]),
    enabled: Boolean(chainId && address),
    ...QUERY_SETTINGS_IMMUTABLE,
  })
...
export const usePoolChartData = (address: string): PoolChartEntry[] | undefined => {
  ...
  const chainId = multiChainId[chainName]
  const { data } = useQuery({
    queryKey: [`extended/info/pool/poolChartData/${chainId}/${address}`, chainId],
    queryFn: () => fetchPoolChartData(address, extendedInfoClients[chainId]),
...
export const usePoolTickData = (address: string): PoolTickData | undefined => {
  ...
  const { data } = useQuery({
    queryKey: [`extended/info/pool/poolTickData/${chainId}/${address}`, chainId],
    queryFn: () => fetchTicksSurroundingPrice(address, extendedInfoClients[chainId], chainId),
    enabled: Boolean(chainId && address),
    ...QUERY_SETTINGS_IMMUTABLE,
  })
  return data?.data ?? undefined
...
export const useSearchData = (
  ...
  const { data, status, error } = useQuery({
    queryKey: [`extended/info/pool/searchData/${chainId}/${searchValue}`, chainId],
