      ...
      {poolData ? (
        <AutoColumn gap="32px">
          <Flex justifyContent="space-between" mb="16px" flexDirection={['column', 'column', 'row']}>
            <Breadcrumbs mb="32px">
              <NextLinkFromReactRouter to={`/${extendedInfoPath}${chainPath}${infoTypeParam}`}>
                <Text color="primary">{t('Info')}</Text>
              </NextLinkFromReactRouter>
              <NextLinkFromReactRouter to={`/${extendedInfoPath}${chainPath}/pairs${infoTypeParam}`}>
          ...
          <Flex flexDirection="column">
            ...
            <Flex justifyContent="space-between" flexDirection={['column', 'column', 'column', 'row']}>
              <Flex flexDirection={['column', 'column', 'row']} mb={['8px', '8px', null]}>
                <NextLinkFromReactRouter
                  to={`/${extendedInfoPath}${chainPath}/tokens/${poolData.token0.address}${infoTypeParam}`}
                >
                  <TokenButton>
                ...
                <NextLinkFromReactRouter
                  to={`/${extendedInfoPath}${chainPath}/tokens/${poolData.token1.address}${infoTypeParam}`}
                >
