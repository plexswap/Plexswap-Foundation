...
import { Box, Card, Flex, Text } from '@plexswap/ui-plex'
...
import { extendedInfoPath, TOKEN_HIDE } from '../../constants'
...
const DataCard = ({ tokenData }: { tokenData: TokenData }) => {
  ...
  return (
    <CardWrapper to={`/${extendedInfoPath}${chainPath}/tokens/${tokenData.address}`}>
      <TopMoverCard>
        <Flex>
