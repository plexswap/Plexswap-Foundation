...
import { ArrowBackIcon, ArrowForwardIcon, Box, SortArrowIcon, Text } from '@plexswap/ui-plex'
...
import { POOL_HIDE, extendedInfoPath } from '../../constants'
...
const DataRow = ({ poolData, index, chainPath }: { poolData: PoolData; index: number; chainPath: string }) => {
  ...
  return (
    <LinkWrapper href={`/${extendedInfoPath}${chainPath}/pairs/${poolData.address}`}>
      <ResponsiveGrid>
