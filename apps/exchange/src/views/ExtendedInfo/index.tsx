...
import { AutoColumn, Box, Button, Card, Heading, Text } from '@plexswap/ui-plex'
          ...
          <BarChart
            ...
            topRight={
              <RowFixed style={{ marginLeft: '-40px', marginTop: '8px' }}>
                <Button
                  scale="sm"
                  variant={volumeWindow === VolumeWindow.daily ? 'primary' : 'cloudyday'}
                ...
                <Button
                  scale="sm"
                  variant={volumeWindow === VolumeWindow.weekly ? 'primary' : 'cloudyday'}
                ...
                <Button
                  variant={volumeWindow === VolumeWindow.monthly ? 'primary' : 'cloudyday'}
                  scale="sm"
                  style={{ marginLeft: '8px' }}
