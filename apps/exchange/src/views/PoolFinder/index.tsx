...
import { AddIcon, AutoColumn, Button, ChevronDownIcon, ColumnCenter, Text, useModal } from '@plexswap/ui-plex'
...
export default function PoolFinder() {
  ...
  const [pairState, pair] = useCorePair(currency0 ?? undefined, currency1 ?? undefined)
              ...
              hasPosition && pair ? (
                <>
                  ...
                  <Button
                    ...
                    to={`/core/pair/${pair.token0.address}/${pair.token1.address}`}
                    variant="secondary"
                    width="100%"
                  >
                    {t('Manage this pair')}
                ...
                <LightCard padding="45px 10px">
                  <AutoColumn gap="sm" justify="center">
                    ...
                    <Button
                      as={NextLinkFromReactRouter}
                      to={`/core/add/${currencyId(currency0)}/${currencyId(currency1)}`}
                      variant="secondary"
                    >
                      {t('Add Liquidity')}
                    </Button>
