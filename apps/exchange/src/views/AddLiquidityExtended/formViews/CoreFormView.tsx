...
import { Pair, Percent } from '@plexswap/sdk-core'
import {
    AutoColumn,
    Box,
    InfoPlaceholder,
...
import { useIsExpertMode } from '@plexswap/utils/user'
...
import { InfoBox } from '@plexswap/widgets-internal'
import ApproveLiquidityTokens from 'views/AddLiquidityExtended/components/ApproveLiquidityTokens'
import { HideMedium, MediumOnly, RightContainer } from './ExtendedFormView'
import RangeSelector from './ExtendedFormView/components/RangeSelector'

export default function CoreFormView({
  formattedAmounts,
  addIsUnsupported,
  addIsWarning,
        ...
        {isOneWeiAttack ? (
          <Message variant="warning">
            <Flex flexDirection="column">
              <MessageText>
                {t(
                  'Adding liquidity to this pair is currently not available on Plexswap UI. Please follow the instructions to resolve it using blockchain explorer.',
                )}
              </MessageText>
              <LinkExternal
                href="https://docs.plexfinance.us/products/plexswap-exchange/faq#why-cant-i-add-liquidity-to-a-pair-i-just-created"
                mt="0.25rem"
              >
      ...
      <RightContainer>
        <AutoColumn pt="12px" gap="24px">
          <DynamicSection disabled gap="12px">
            <InfoBox message={t('Your position will appear here.')} icon={<InfoPlaceholder />} />
            <RangeSelector
