...
import {
    ...
    ZOOM_LEVELS,
    ZoomLevels,
} from '@plexswap/widgets-internal'
...
import { FeeAmount, NonfungiblePositionManager } from '@plexswap/sdk-extended'
...
import { ExtendedSubmitButton } from 'views/AddLiquidityExtended/components/ExtendedSubmitButton'
import { QUICK_ACTION_CONFIGS } from 'views/AddLiquidityExtended/types'
...
import { useExtendedMintActionHandlers } from './form/hooks/useExtendedMintActionHandlers'
import { useInitialRange } from './form/hooks/useInitialRange'
import { useRangeHopCallbacks } from './form/hooks/useRangeHopCallbacks'
import { useExtendedFormAddLiquidityCallback, useExtendedFormState } from './form/reducer'
...
interface ExtendedFormViewPropsType {
...
export default function ExtendedFormView({
  feeAmount,
  baseCurrency,
  quoteCurrency,
  currencyIdA,
  currencyIdB,
}: ExtendedFormViewPropsType) {
  ...
  const { onFieldAInput, onFieldBInput, onLeftRangeInput, onRightRangeInput, onStartPriceInput, onBothRangeInput } =
    useExtendedMintActionHandlers(noLiquidity)
  ...
  const onAddLiquidityCallback = useExtendedFormAddLiquidityCallback()
            ...
            <Box>
              ...
              <Message variant="warning" mb="8px">
                <MessageText>
                  ...
                  <b>{t('Fee-on transfer tokens and rebasing tokens are NOT compatible with Extended.')}</b>
                </MessageText>
              </Message>
