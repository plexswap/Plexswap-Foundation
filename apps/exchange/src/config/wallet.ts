...
import { WalletFilledIcon } from '@plexswap/ui-plex'
import { WalletConfigCore } from '@plexswap/wallets'
import { getTrustWalletProvider } from '@plexswap/wagmi/connectors/trustWallet'
...
}): WalletConfigCore<ConnectorNames>[] => {
  ...
  return [
    {
      ...
      deepLink: 'https://metamask.app.link/dapp/plexswap.finance/',
      qrCode,
      downloadLink: 'https://metamask.app.link/dapp/plexswap.finance/',
    },
    {
      id: 'BinanceW3W',
    ...
    },
    {
      ...
      deepLink: 'https://link.trustwallet.com/open_url?coin_id=20000714&url=https://plexswap.finance/',
    ...
    },
    {
      id: 'rabby',
      title: 'Rabby Wallet',
      icon: `${ASSET_CDN}/images/wallets/rabby.png`,
      get installed() {
...
export const getDocLink = (code: string) =>
  docLangCodeMapping[code]
    ? `https://docs.plexfinance.us/v/${docLangCodeMapping[code]}/get-started/wallet-guide`
    : `https://docs.plexfinance.us/get-started/wallet-guide`