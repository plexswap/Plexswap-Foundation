export const wayaWrapperABI = [
  ...
  },
  {
    inputs: [
      ...
      { internalType: 'bool', name: '_noHarvest', type: 'bool' },
    ],
    name: 'deposit',
    outputs: [],
  ...
  {
    inputs: [{ internalType: 'address', name: '_userAddress', type: 'address' }],
    name: 'updateBoostMultiplierByUser',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'unsettledRewards', type: 'uint256' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
