...
import { ERC20Token, Pair } from '@plexswap/sdk-core'
import { useFeeData } from '@plexswap/wagmi'
 ...
 */
export function coreLiquidityToken([tokenA, tokenB]: [ERC20Token, ERC20Token]): ERC20Token {
  return new ERC20Token(tokenA.chainId, Pair.getAddress(tokenA, tokenB), 18, 'Waya-LP', 'Plexswap LPs')
}
