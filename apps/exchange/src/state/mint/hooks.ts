...
import { Currency, CurrencyAmount, Pair, Percent, Price, Token } from '@plexswap/sdk-core'
...
import { useAddLiquidityFormDispatch, useAddLiquidityFormState } from 'state/mint/reducer'
...
export function useDerivedMintInfo(
  ...
  // pair
  const [pairState, pair] = useCorePair(currencies[Field.CURRENCY_A], currencies[Field.CURRENCY_B])
