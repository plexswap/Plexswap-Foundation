...
import { BurnResponse, MintResponse, PairDayData, PlexDayData, SwapResponse, TokenDayData } from './types'
...
export const mapDayData = (tokenDayData: TokenDayData | PlexDayData): ChartEntry => ({
