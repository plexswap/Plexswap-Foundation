...
import { SwapParameters, TradeType } from '@plexswap/sdk-core'
import isZero from '@plexswap/utils/isZero'
import truncateHash from '@plexswap/utils/truncateHash'
import { CoreTradeAndStableSwap, isStableSwap } from 'config/constants/types'
...
export function useSwapCallback(
  trade: CoreTradeAndStableSwap | null, // trade to execute, required
        ...
        return contract.write[methodName](args, {
          ...
          .then((response: Hash) => {
            ...
            logSwap({
              ...
              type: isStableSwap(trade) ? 'StableSwap' : 'CoreSwap',
            })
