...
import { OnChainProvider, SmartRouter } from '@plexswap/gateway-guardians'
import { Pool } from '@plexswap/gateway-guardians/Ananke'
...
export const useCoreCandidatePools = candidatePoolsOnChainHookFactory('V2', SmartRouter.getCorePoolsOnChain)

export const useStableCandidatePools = candidatePoolsOnChainHookFactory('Stable', SmartRouter.getStablePoolsOnChain)

export const useExtendedPoolsWithoutTicksOnChain = candidatePoolsOnChainHookFactory(
  'Extended without ticks',
  SmartRouter.getExtendedPoolsWithoutTicksOnChain,
)
