...
import { Currency, CurrencyAmount, Price, Token } from '@plexswap/sdk-core'
...
import { MintState } from 'views/AddLiquidityExtended/formViews/ExtendedFormView/form/reducer'
...
export default function useExtendedDerivedInfo(
  currencyA?: Currency,
  currencyB?: Currency,
  feeAmount?: FeeAmount,
