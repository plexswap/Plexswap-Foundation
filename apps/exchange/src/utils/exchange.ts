import { Currency, CurrencyAmount, Fraction, Percent, Trade, TradeType } from '@plexswap/sdk-core'
import { plexRouterABI } from 'config/abi/IPlexswapRouter'
import {
...
export function useRouterContract() {
  ...
  return useContract(chainId && ROUTER_ADDRESS[chainId], plexRouterABI)
}
