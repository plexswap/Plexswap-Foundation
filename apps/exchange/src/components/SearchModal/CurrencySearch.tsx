import { useDebounce, useSortedTokensByQuery } from '@plexswap/hooks'
import { useTranslation } from '@plexswap/localization'
import { UsdvWidget } from '@plexswap/widgets-internal'
/* eslint-disable no-restricted-syntax */
import { WrappedTokenInfo, createFilterToken } from '@plexswap/metalists'
import { Currency, Token } from '@plexswap/sdk-core'
import { AutoColumn, Box, Column, Input, Text, useMatchBreakpoints } from '@plexswap/ui-plex'
import { useAudioPlay } from '@plexswap/utils/user'
