...
import { Button, Text, Link, HelpIcon, Message, MessageText } from '@plexswap/ui-plex'
...
const WalletWrongNetwork: React.FC<React.PropsWithChildren<WalletWrongNetworkProps>> = ({ onDismiss }) => {
  ...
  return (
    <>
      ...
      <StyledLink href="https://docs.plexfinance.us/get-started/connection-guide" external>
