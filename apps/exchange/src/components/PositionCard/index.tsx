...
import { Currency, CurrencyAmount, Pair, Percent } from '@plexswap/sdk-core'
import { AutoColumn, Card, CardBody, CardProps, Flex, Link, Text, TooltipText, useTooltip } from '@plexswap/ui-plex'
