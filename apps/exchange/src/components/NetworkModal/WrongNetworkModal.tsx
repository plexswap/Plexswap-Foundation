...
import { ArrowForwardIcon, Button, FlexGap, Grid, Message, MessageText, Modal, Text } from '@plexswap/ui-plex'
    ...
    <Modal title={t('You are in wrong network')} headerBackground="gradientCardHeader" onDismiss={onDismiss}>
      <Grid style={{ gap: '16px' }} maxWidth="336px">
        ...
        <div style={{ textAlign: 'center' }}>
          <Image width={184} height={140} src="/images/check-your-network.png" alt="check your network" />
        </div>
